...
// +----------------------------------------------------------------------
return [
    "TIME_GT_NOW"                   => 'The date cannot be greater than the present!',
    "LOGIN_FIRST"                   => 'Please login first!',
    "VALIDATE_FAILED"               => 'Image verification code error!',
    "INPUT_NEW_VALIDATE"            => 'Please enter new image verification code!',
    "CORRECT_EMAIL_FORMAT"          => 'Please enter the correct email format!',
    "USERNAME_EXIST"                => 'The user name already exists!',
    "OVER_PROOF"                    => 'The verification code sends too much. Please try again tomorrow!',
    "VERIFICATION_SEND_SUCCESS"     => 'The verification code has been sent successfully!',
    "SEND_CHANGE_EMAIL"             => 'Please go to the official website to relaunch the email to change password',
    "PLEASE_UPLOADS"                => 'Please uplaod files!',
    "UPLOAD_FAILED"                 => 'Upload failed!',
    "FORMAT_INCORRECT"              => 'Invalid file format upload attempt!',
    "PLEASE_RETRY"                  => 'The network is busy, please try again!',
    "NO_PRO_INSALE"                 => 'There are no items on sale!',
    "INVENTORY_SHORTAGE"            => 'Inventory shortage!',
    "ILLEGAL_ARGUMENT"              => 'ILLEGAL_ARGUMENT',
    "BUY_SUCCESS"                   => 'Purchase succeeds!',
    "FEEDBACK_SUCCESS"              => 'Feedback has been submitted!',
    "FEEDBACK_FAILED"               => 'Feedback submission failed!',
    "EMAIL_EXIST"                   => 'Mailbox already exists!',
    "FRIEND_EMAIL_SENDED"           => 'Nvitations to friends have been sent successfully!',
    "FRIEND_EMAIL_UNSEND"           => 'Invite a friend to email a failure!',
    "CHANGE_EMAIL_SENDED"           => 'Change password mailbox link has been sent successfully!',
    "CHANGE_EMAIL_UNSEND"           => 'Change password mailbox link has been sent failure!',
